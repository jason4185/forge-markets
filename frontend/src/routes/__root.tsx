...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  if (import.meta.env.DEV) console.error("[FORGE ERROR]", error);
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FORGE — Commodity dominance markets" },
      {
        name: "description",
        content: "Commodity dominance markets, one hour at a time.",
      },
      { name: "author", content: "FORGE" },
      { property: "og:title", content: "FORGE — Commodity dominance markets" },
      {
